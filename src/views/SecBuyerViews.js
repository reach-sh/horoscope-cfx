...
exports.Attach = class extends React.Component {
  render() {
    ...
    return (
      <div>
         Do you want to attach to the Destiny of Starry Sky? Please paste the contract info here:
        <br />
        ...
        >Join the Destiny of Starry Sky: Horoscope DAPP</button>
      </div>
    );
  }
}
...
exports.Attaching = class extends React.Component {
  render() {
    return (
      <div>
        Join the Destiny of Starry Sky: Horoscope DAPP
      </div>
    );
  }
}
...
exports.showNFT = class extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      这是您的预测结果以及NFT属性
      <br />
      <img src={Photo5} alt="logo" className="imgsize"/>
      <br />
      <br />NFT id为：{id1}
      <br />所有人地址为：{owner}
      <br />爱情运势为：{love1}分
